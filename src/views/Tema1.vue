...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .col-lg-10
        ...
        .row.justify-content-center
          ...
          .col-lg-10
            ...
            p En este contexto, resulta pertinente conocer las principales disposiciones que regulan la organización y el funcionamiento del sector salud, así como su incidencia en los procesos de acreditación.
    ...
    .row.justify-content-center.mb-4
      .col-lg-10
        .bloque-texto-gg.tarjeta.bg1.mb-4
